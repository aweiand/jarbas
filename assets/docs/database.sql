...
SELECT pg_catalog.setval('actlogs_id_seq', 3, true);
...
SELECT pg_catalog.setval('eventos_id_seq', 5, true);
...
SELECT pg_catalog.setval('salas_id_seq', 1, true);
...
SELECT pg_catalog.setval('tipos_id_seq', 7, true);
