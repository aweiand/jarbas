...
?>
<!-- JS Struct -->
<script type="text/javascript" src="<?= $CFG->affix . $CFG->lib ?>plugins/jquery/js/jquery-1.9.1.js"></script>
<script type="text/javascript" src="<?= $CFG->affix . $CFG->lib ?>plugins/jquery/js/jquery-ui-1.10.3.custom.min.js"></script>
<script type="text/javascript" src="<?= $CFG->affix . $CFG->lib ?>plugins/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?= $CFG->affix . $CFG->lib ?>plugins/jquery/DataTables-1.9.4/media/js/jquery.dataTables.min.js"></script>
...
<script type="text/javascript" src="<?= $CFG->affix . $CFG->lib ?>js/eventos.js"></script>

<!-- CSS Struct -->	
<link rel="stylesheet" type="text/css" href="<?= $CFG->affix . $CFG->lib ?>plugins/jquery/tokeninput/styles/token-input.css" />
<link rel="stylesheet" type="text/css" href="<?= $CFG->affix . $CFG->lib ?>plugins/jquery/tokeninput/styles/token-input-facebook.css" />
<link rel="stylesheet" type="text/css" href="<?= $CFG->affix . $CFG->lib ?>plugins/jquery/jpicker/css/jPicker-1.1.6.min.css" />
